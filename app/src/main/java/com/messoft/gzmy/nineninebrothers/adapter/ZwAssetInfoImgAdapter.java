...
public class ZwAssetInfoImgAdapter extends BaseRecyclerViewAdapter<AssetInfoFile> {
    private Activity activity;

    public ZwAssetInfoImgAdapter(Activity activity) {
    ...
    class ViewHolder extends BaseRecyclerViewHolder<AssetInfoFile, ItemZsPersonInfoImgBinding> {
        ...
        @Override
        public void onBindViewHolder(final AssetInfoFile object, final int position) {
            if (object != null) {
                /**
