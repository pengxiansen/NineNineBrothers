...
public class ZsDataInfoImgAdapter extends BaseRecyclerViewAdapter<ZsDataInfoFileById> {
    private Activity activity;

    public ZsDataInfoImgAdapter(Activity activity) {
    ...
    class ViewHolder extends BaseRecyclerViewHolder<ZsDataInfoFileById, ItemZsPersonInfoImgBinding> {
        ...
        @Override
        public void onBindViewHolder(final ZsDataInfoFileById object, final int position) {
            if (object != null) {
                /**
