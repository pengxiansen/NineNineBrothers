...
public class AssetProgressAdapter extends BaseRecyclerViewAdapter<AssetProgress> {
    private Activity activity;
    private JzModel mJzModel;

    public AssetProgressAdapter(Activity activity) {
    ...
    class ViewHolder extends BaseRecyclerViewHolder<AssetProgress, ItemJzProgressListBinding> {
        ...
        @Override
        public void onBindViewHolder(final AssetProgress object, int position) {
            if (object != null) {
                binding.tvTitle.setText(BusinessUtils.assetProgressStage(object.getProgressStage()+""));
