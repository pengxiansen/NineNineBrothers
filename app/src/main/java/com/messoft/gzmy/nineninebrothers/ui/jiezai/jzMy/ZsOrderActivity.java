...
import com.messoft.gzmy.nineninebrothers.databinding.ActivityZsOrderBinding;
 ...
 * @作者 Administrator
 * 债事订单
 * @创建日期 2017/11/10 0010 17:44
 */

public class ZsOrderActivity extends BaseActivity<ActivityZsOrderBinding> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zs_order);
    ...
    private void initFragmentList() {
        ...
        //这里解债师跟合伙人用的接口一样
        mFragments.add(JzPropertyJzsFragment.newInstance("1","0"));
        mFragments.add(JzPropertyJzsFragment.newInstance("1","1"));
        mFragments.add(JzPropertyJzsFragment.newInstance("1","2"));
    }
}
