...
public class JzPropertyJzsdapter extends BaseRecyclerViewAdapter<QueryAssetDiscussApplyListWithAssetInfo> {
    private Activity activity;

    public JzPropertyJzsdapter(Activity activity) {
    ...
    class ViewHolder extends BaseRecyclerViewHolder<QueryAssetDiscussApplyListWithAssetInfo, ItemAssetListBinding> {
        ...
        @Override
        public void onBindViewHolder(final QueryAssetDiscussApplyListWithAssetInfo object, int position) {
            if (object != null) {
                /**
                ...
                binding.tvTime.setText("解债时间："+object.getEndDate());
                ImgLoadUtil.displayEspImageHasHead(object.getPath(),binding.ivHead,0);
