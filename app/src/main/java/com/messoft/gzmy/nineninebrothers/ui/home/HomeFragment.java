...
//        loadHomeData();
    ...
    private void loadHeadType() {
        ...
        listHead.add(new HomeHeadType("资产解债", R.drawable.default_header));
        listHead.add(new HomeHeadType("衣食住行", R.drawable.default_header));
        listHead.add(new HomeHeadType("会员商城", R.drawable.default_header));
        listHead.add(new HomeHeadType("合伙申请", R.drawable.default_header));
        listHead.add(new HomeHeadType("投资理财", R.drawable.default_header));
        listHead.add(new HomeHeadType("资讯活动", R.drawable.default_header));
