...
import com.messoft.gzmy.nineninebrothers.databinding.ActivityJzBeiAnNextFourBinding;
...
public class JzBeiAnNextFourActivity extends BaseActivity<ActivityJzBeiAnNextFourBinding> implements BGASortableNinePhotoLayout.Delegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jz_bei_an_next_four);
    ...
    private void initListener() {
        ...
        bindingView.scrollView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                KeybordUtils.inputClose(bindingView.scrollView, JzBeiAnNextFourActivity.this);
                ...
                bindingView.tvNext.setOnClickListener(new PerfectClickListener() {
                    ...
                    protected void onNoDoubleClick(View v) {
                        ...
                        if (data != null && data.size() > 0) {
                            DebugUtil.debug("JzBeiAnNextFourActivity" + data.toString());
...
//                ToastUtil.showToast("申请权限成功");
                ...
                startActivityForResult(BGAPhotoPickerActivity.newIntent(JzBeiAnNextFourActivity.this, takePhotoDir,
            ...
            public void onFailure(List<String> permissions) {
                ...
                if (AndPermission.hasAlwaysDeniedPermission(JzBeiAnNextFourActivity.this, permissions)) {
                    // 第一种：用默认的提示语。
                    AndPermission.defaultSettingDialog(JzBeiAnNextFourActivity.this, 110).show();
                }
            }
        });
